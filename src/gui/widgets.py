...
class ToggleNameLabel(QLabel):
    """A QLabel that changes font weight and color as a status indicator."""

    def __init__(self, text, parent=None):
        super().__init__(text, parent)
        self._checked = False
        self._on_color = "#8be9fd"
        self._off_color = None
        self._extra_style = ""

    def setStatusColors(self, on_color: str = None, off_color: str = None):
        if on_color:
    ...
    def setExtraStyle(self, style: str):
        self._extra_style = style or ""
        self._apply_status_style()
    ...
    def _apply_status_style(self):
        ...
        if self._extra_style:
            styles.append(self._extra_style)
...
class ToggleSwitch(QCheckBox):
    ...
    def __init__(
        ...
        self.setCursor(Qt.CursorShape.PointingHandCursor)
        self.setStyleSheet(
            "QCheckBox { spacing: 0px; } QCheckBox::indicator { width: 0px; height: 0px; }"
        )
